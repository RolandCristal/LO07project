    ...
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg bg-primary fixed-top">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">Samuel Monier</a>
      ...
      <div class="card">
        <div class="card-body bg-info">
          <h5 class="card-title">Exercice 3 : Sondage UT</h5>
            ...
            <table class="table">
                ...
                <?php 
                    ...
                    foreach ($_POST as $key => $value){
                        $index+=1;
                        if ($key=='ut'){
                            echo '<tr><th>' . $index . '</th><td>' . $key . '</td><td>' . implode(', ', $value) . '</td></tr>';
                        }else{
                            echo '<tr><th>' . $index . '</th><td>' . $key . '</td><td>' . $value . '</td></tr>';
                        }
                    }
                ?>
            </table>
