<?php
    ...
    $_SESSION["nom_organisation"] = $_POST["nom_organisation"];
    $_SESSION["adresse_organisation"] = $_POST["adresse_organisation"];
    $_SESSION["date_ouverture"] = $_POST["date_ouverture"];
      ...
      <div class="card">
        <div class="card-body bg-info">
          ...
          <div class='mx-lg-3'> 
             ...
             <form method="POST" action="td07_e3_f3_sessions.php"> 
