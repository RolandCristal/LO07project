<?php
    ...
    $_SESSION["nom_respo_organisation"] = $_POST["nom_respo_organisation"];
    $_SESSION["nom_respo_traitement"] = $_POST["nom_respo_traitement"];
    $_SESSION["nom_délégué_donnée"] = $_POST["nom_délégué_donnée"];
...
<html lang="fr">
  <head>
    ...
    <title>Exercice 3 sessions</title>
    <link 
      ...
      <div class="card">
        <div class="card-body bg-info">
          ...
          <div class='mx-lg-3'> 
             ...
             <form method="POST" action="intermediaire sessions.php">   <?php //lo07_analyse_superglobales2.php ?>
                                                                        <?php //intermediaire sessions.php ?>
