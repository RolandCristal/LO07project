<?php
    ...
    setcookie("nom_respo_organisation", $_POST["nom_respo_organisation"]); // 86400 = 1 jour
    setcookie("nom_respo_traitement", $_POST["nom_respo_traitement"]);
    setcookie("nom_délégué_donnée", $_POST["nom_délégué_donnée"]);
...
<html lang="fr">
  <head>
    ...
    <title>Exercice 3 cookies</title>
    <link 
      ...
      <div class="card">
        <div class="card-body bg-info">
          ...
          <div class='mx-lg-3'> 
             ...
             <form method="POST" action="intermediaire cookie.php">    <?php //lo07_analyse_superglobales2.php ?>
                                                                        <?php //intermediaire cookie.php ?>
                <div class="mb-3">                             
