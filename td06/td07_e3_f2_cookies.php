<?php
    ...
    setcookie("nom_organisation", $_POST["nom_organisation"]); // 86400 = 1 jour
    setcookie("adresse_organisation", $_POST["adresse_organisation"]);
    setcookie("date_ouverture", $_POST["date_ouverture"]);
      ...
      <div class="card">
        <div class="card-body bg-info">
          ...
          <div class='mx-lg-3'> 
             ...
             <form method="POST" action="td07_e3_f3_cookies.php"> 
