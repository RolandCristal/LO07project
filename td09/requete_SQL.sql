...
-- Cela provoque une erreur à cause des contraintes d'intégrité référentielle avec la table recolte.
-- Il faut d'abord supprimer la clé étrangère, puis la table.
